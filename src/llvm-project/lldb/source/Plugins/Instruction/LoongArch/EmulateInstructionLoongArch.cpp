...
const char *EmulateInstructionLoongArch::GetPluginDescriptionStatic() {
...
ConstString EmulateInstructionLoongArch::GetPluginNameStatic() {
  ConstString g_plugin_name("lldb.emulate-instruction.loongarch");
  return g_plugin_name;
}

lldb_private::ConstString EmulateInstructionLoongArch::GetPluginName() {
  static ConstString g_plugin_name("EmulateInstructionLoongArch");
  return g_plugin_name;
}
